...
class LatencyStage(StrEnum):
    ...
    CALLEE_SPEECH_ENDED = "callee_speech_ended"
    CARRIER_OUTPUT_STARTED = "carrier_output_started"
    CARRIER_OUTPUT_ENDED = "carrier_output_ended"
    BACKEND_RESPONSE_CREATED = "backend_response_created"
    BACKEND_RESPONSE_COMPLETED = "backend_response_completed"
